      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={styles.imageShowcase}>
          ...
          <div className={styles.detailThumbnails}>
            ...
            <button 
              className={`${styles.thumbImgButton} ${detailMainImage === 'https://lh3.googleusercontent.com/aida/ADBb0ujP0BmZTk0IVcdllVj0erCnC_Fa7atY4sPeLUMwCmttOZnXOR6MGAyxPzftwtlwBQmnT3lFsPyb7hp7EjnF_BTAkjuEX4bn2i5nNduk03Ns9DXhDvEIxLJWg700HTOye2qlIYTUWKParwjDUMR6tigLLXlPC43UAc0scOzb3prHnxOByu2aVMXnbT1xl1TO_AhcJSV0QmuAlYJmtX-Dgd2i5ljiHnByqP6ZESM1NiG2OS36j4FRP5zOFVc' ? styles.thumbActive : ''}`}
              onClick={() => setDetailMainImage('https://lh3.googleusercontent.com/aida/ADBb0ujP0BmZTk0IVcdllVj0erCnC_Fa7atY4sPeLUMwCmttOZnXOR6MGAyxPzftwtlwBQmnT3lFsPyb7hp7EjnF_BTAkjuEX4bn2i5nNduk03Ns9DXhDvEIxLJWg700HTOye2qlIYTUWKParwjDUMR6tigLLXlPC43UAc0scOzb3prHnxOByu2aVMXnbT1xl1TO_AhcJSV0QmuAlYJmtX-Dgd2i5ljiHnByqP6ZESM1NiG2OS36j4FRP5zOFVc')}
              title="Góc nghệ nhân"
            >
              <img src="https://lh3.googleusercontent.com/aida/ADBb0ujP0BmZTk0IVcdllVj0erCnC_Fa7atY4sPeLUMwCmttOZnXOR6MGAyxPzftwtlwBQmnT3lFsPyb7hp7EjnF_BTAkjuEX4bn2i5nNduk03Ns9DXhDvEIxLJWg700HTOye2qlIYTUWKParwjDUMR6tigLLXlPC43UAc0scOzb3prHnxOByu2aVMXnbT1xl1TO_AhcJSV0QmuAlYJmtX-Dgd2i5ljiHnByqP6ZESM1NiG2OS36j4FRP5zOFVc" alt="Góc nghệ nhân" />
            </button>
